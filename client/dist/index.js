...
var Tip = require('admin/components/Tip/Tip');

/* global document */
var registerEntwineHook = (() => jQuery.entwine('ss', $ => {
  $('.js-injector-boot input.extrashortcodes').entwine({
    onmatch() {
      const renderRoot = document.createElement('div');
      this[0].parentNode.insertBefore(renderRoot, this[0]);
      const ShortcodableTextField = Injector.loadComponent('ShortcodableTextField');
      const props = {
        linkedInput: this[0],
        validCodes: ['maori']
      };
      client.createRoot(renderRoot).render( /*#__PURE__*/React.createElement(ShortcodableTextField, {
        ...props
      }));
    },
    onunmatch() {
...
function d(n, e) {
  return void 0 === e && (e = !1), y(n) || r$1(n) || !t$1(n) ? n : (o(n) > 1 && (n.set = n.add = n.clear = n.delete = h), Object.freeze(n), e && i(n, function (n, r) {
    return d(r, !0);
  }, !0), n);
}
function h() {
...
function _() {
  return "production" === process.env.NODE_ENV || U || n$2(0), U;
}
function j(n, r) {
...
function P(r, e) {
  ...
  var i = e.p[0],
    o = void 0 !== r && r !== i;
  return e.h.g || b("ES5").S(e, r, o), o ? (i[Q].P && (O(e), n$2(4)), t$1(r) && (r = M(e, r), e.l || x(e, r)), e.u && b("Patches").M(i[Q].t, r, e.u, e.s)) : r = M(e, i, []), O(e), e.u && e.v(e.u, e.s), r !== H ? r : void 0;
}
function M(n, r, t) {
  if (y(r)) return r;
  var e = r[Q];
...
function A(e, i, o, a, c, s) {
  if ("production" !== process.env.NODE_ENV && c === o && n$2(5), r$1(c)) {
    var v = M(e, c, s && i && 3 !== i.i && !u(i.D, a) ? s.concat(a) : void 0);
    if (f$2(o, a, v), !r$1(v)) return;
    e.m = !1;
  }
  if (t$1(c) && !y(c)) {
...
function D(e) {
  return r$1(e) || n$2(22, e), function n(r) {
    if (!t$1(r)) return r;
    var e,
      u = r[Q],
      c = o(r);
...
var G,
  ...
  en = {
    get: function (n, r) {
      ...
      var i = e[r];
      return n.I || !t$1(i) ? i : i === z(n.t, r) ? (E(n), n.o[r] = R$1(n.A.h, i, n)) : i;
    },
    has: function (n, r) {
      return r in p(n);
    },
...
i(en, function (n, r) {
  ...
  return "production" !== process.env.NODE_ENV && isNaN(parseInt(t)) && n$2(13), on.set.call(this, r, t, void 0);
}, on.set = function (r, t, e) {
  return "production" !== process.env.NODE_ENV && "length" !== t && isNaN(parseInt(t)) && n$2(14), en.set.call(this, r[0], t, e, r[0]);
};
var un = function () {
    function e(r) {
      var e = this;
      this.g = B, this.F = !0, this.produce = function (r, i, o) {
        ...
        var f;
        if ("function" != typeof i && n$2(6), void 0 !== o && "function" != typeof o && n$2(7), t$1(r)) {
          var c = w(e),
            s = R$1(e, r, void 0),
            v = !0;
          try {
    ...
    return i.createDraft = function (e) {
      t$1(e) || n$2(8), r$1(e) && (e = D(e));
      var i = w(this),
        o = R$1(this, e, void 0);
      return o[Q].C = !0, g(i), o;
    }, i.finishDraft = function (r, t) {
      var e = r && r[Q];
      "production" !== process.env.NODE_ENV && (e && e.C || n$2(9), e.I && n$2(10));
      var i = e.A;
...
var Editor = {
  ...
  isEditor(value) {
    ...
    var isEditor = typeof value.addMark === 'function' && typeof value.apply === 'function' && typeof value.deleteBackward === 'function' && typeof value.deleteForward === 'function' && typeof value.deleteFragment === 'function' && typeof value.insertBreak === 'function' && typeof value.insertSoftBreak === 'function' && typeof value.insertFragment === 'function' && typeof value.insertNode === 'function' && typeof value.insertText === 'function' && typeof value.isInline === 'function' && typeof value.isVoid === 'function' && typeof value.normalizeNode === 'function' && typeof value.onChange === 'function' && typeof value.removeMark === 'function' && typeof value.getDirtyPaths === 'function' && (value.marks === null || isPlainObject$1(value.marks)) && (value.selection === null || Range.isRange(value.selection)) && Node.isNodeList(value.children) && Operation.isOperationList(value.operations);
...
var Text$1 = {
  ...
  decorations(node, decorations) {
    var leaves = [_objectSpread$4$1({}, node)];
    for (var dec of decorations) {
      var rest = _objectWithoutProperties$1(dec, _excluded2$1$1);
      ...
      for (var leaf of leaves) {
        ...
        if (decorationEnd < leafEnd) {
          ...
          after = _objectSpread$4$1(_objectSpread$4$1({}, middle), {}, {
            text: middle.text.slice(off)
          });
          middle = _objectSpread$4$1(_objectSpread$4$1({}, middle), {}, {
            text: middle.text.slice(0, off)
          });
        }
        if (decorationStart > leafStart) {
          var _off = decorationStart - leafStart;
          before = _objectSpread$4$1(_objectSpread$4$1({}, middle), {}, {
...
function isHotkey$1(hotkey, options, event) {
  ...
  var array = hotkey.map(function (string) {
    return parseHotkey$1(string, options);
  });
  var check = function check(e) {
    return array.some(function (object) {
      return compareHotkey$1(object, e);
    });
  };
...
function parseHotkey$1(hotkey, options) {
  ...
  for (var k in MODIFIERS$1) {
    ret[MODIFIERS$1[k]] = false;
  }
  ...
  try {
    for (var _iterator = values[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var name = toKeyName$1(value);
      var modifier = MODIFIERS$1[name];
...
function toKeyCode$1(name) {
  name = toKeyName$1(name);
  var code = CODES$1[name] || name.toUpperCase().charCodeAt(0);
  return code;
}
function toKeyName$1(name) {
  name = name.toLowerCase();
  name = ALIASES$1[name] || name;
  return name;
}
...
lib$2.default = isHotkey$1;
lib$2.isHotkey = isHotkey$1;
lib$2.isCodeHotkey = isCodeHotkey$1;
var isKeyHotkey_1 = lib$2.isKeyHotkey = isKeyHotkey$1;
lib$2.parseHotkey = parseHotkey$1;
lib$2.compareHotkey = compareHotkey$1;
lib$2.toKeyCode = toKeyCode$1;
lib$2.toKeyName = toKeyName$1;
...
function useAndroidInputManager(_ref) {
  ...
  var [inputManager] = React.useState(() => createAndroidInputManager(_objectSpread$2({
    editor
  }, options)));
...
var Editable = props => {
  ...
  var scheduleOnDOMSelectionChange = React.useMemo(() => debounce_1(onDOMSelectionChange, 0), [onDOMSelectionChange]);
...
var withReact = editor => {
  ...
  e.apply = op => {
    ...
    if (pendingAction !== null && pendingAction !== void 0 && pendingAction.at) {
      ...
      EDITOR_TO_PENDING_ACTION.set(e, at ? _objectSpread$4(_objectSpread$4({}, pendingAction), {}, {
        at
      }) : null);
    }
    switch (op.type) {
...
lib$1.isEOL = lib$1.isStringNode = isTagNode_1 = lib$1.isTagNode = lib$1.getUniqAttr = lib$1.getNodeLength = lib$1.escapeHTML = lib$1.appendToNode = lib$1.attrValue = lib$1.attrsToString = void 0;
var _char$1 = char;
...
var attrsToString = function (values) {
  ...
  return keysReduce(values, function (arr, key) {
    return _toConsumableArray(arr).concat([attrValue(key, values[key])]);
  }, ['']).join(' ');
};
/**
 * Gets value from
...
lib$1.attrsToString = attrsToString;
lib$1.attrValue = attrValue;
lib$1.appendToNode = appendToNode;
lib$1.escapeHTML = escapeHTML;
lib$1.getNodeLength = getNodeLength;
lib$1.getUniqAttr = getUniqAttr;
var isTagNode_1 = lib$1.isTagNode = isTagNode;
lib$1.isStringNode = isStringNode;
lib$1.isEOL = isEOL;
  ...
  _createClass$1(TagNode, [{
    ...
    value: function toTagStart(param) {
      var ref = param === void 0 ? {} : param,
        ...
        closeTag = _closeTag === void 0 ? _char.CLOSE_BRAKET : _closeTag;
...
var _default$1 = TagNode;
default_1 = TagNode$1.default = _default$1;
...
function createLexer(buffer, param) {
  ...
  */
  ...
  var RESERVED_CHARS = [closeTag, openTag, QUOTEMARK_1, BACKSLASH_1, SPACE_1, TAB_1, EQ_1, N_1, EM];
  var NOT_CHAR_TOKENS = [
  // ...(options.enableEscapeTags ? [BACKSLASH] : []),
  openTag, SPACE_1, TAB_1, N_1];
...
const toSlateNodeTree = (input, validCodes) => {
  if (!validCodes || validCodes.length === 0 || !input) {
    return [createSlateNode.fromString(input)];
  }
  const parserOptions = {
    onlyAllowTags: validCodes
  };
  const codeNodes = parse(input, parserOptions);
  return codeNodes.map(node => typeof node === 'object' && typeof node.tag === 'string' && node.tag ? createSlateNode.fromShortcodeNode(node) : createSlateNode.fromString(node));
};
const toStringFromSlate = {
  shortcodeElement: node => {
    ...
    const attributesString = Object.keys(attributes).reduce((prev, attribute) => `${prev} ${stringifyAttribute(attribute)}`, '');
    return `[${code}${attributesString}]${Node.string(node)}[/${code}]`;
  },
  textNode: node => Node.string(node),
  elementNode: node => Element$2.isElementType(node, 'shortcode') ? toStringFromSlate.shortcodeElement(node) : toStorableString(node.children) // eslint-disable-line no-use-before-define
};

const toStorableString = tree => tree.reduce((value, node) => value + (Text$1.isText(node) ? toStringFromSlate.textNode(node) : toStringFromSlate.elementNode(node)), '');

var ShortcodeEditor = /*#__PURE__*/React.forwardRef(({
  isEditing
}, ref) => /*#__PURE__*/React.createElement("dialog", {
  ref: ref
}, /*#__PURE__*/React.createElement("form", {
  method: "dialog"
}, /*#__PURE__*/React.createElement("select", null, /*#__PURE__*/React.createElement("option", {
  value: "maori"
}, "Te reo M\u0101ori"), /*#__PURE__*/React.createElement("option", {
  value: "invalid"
}, "Not actually a shortcode"), /*#__PURE__*/React.createElement("option", {
  value: "third"
...
var InputMenu = (({
  ...
  }, shortcodeInRange ? 'Edit' : 'Add'), shortcodeInRange && 'or', shortcodeInRange && /*#__PURE__*/React.createElement("button", null, "Remove"), title, /*#__PURE__*/React.createElement(ShortcodeEditor, {
    ref: dialog
  }));
});
...
var Element = (elementProps => Element$2.isElementType(elementProps.element, 'shortcode') ? /*#__PURE__*/React.createElement(ShortcodeElement, elementProps) : /*#__PURE__*/React.createElement(DefaultElement, elementProps));
...
const applyShortcode = (editor, shortcode) => Range.isExpanded(editor.selection) && Transforms.wrapNodes(editor, {
  type: 'shortcode',
  shortcode
}, {
  split: true,
...
const removeShortcode = editor => Transforms.unwrapNodes(editor, {
  match: node => editor.isShortcode(node)
});
const openShortcodeConfigurator = editor => applyShortcode(editor, 'maori');
var openShortcodeEditor = (editor => {
...
const isShortcodeHotkey = _default('alt+m');
var detectKeyboardShortcut = (editor => {
...
const cloneKeyboardEvent = ({
  ...
  altKey,
  metaKey
}, overrideType = null, overrideOptions = {}) => new KeyboardEvent(overrideType || type, {
  bubbles,
  cancelable,
  composed,
  detail,
...
var withShortcodes = (editor => {
  const {
    isInline: originalIsInline
  } = editor;
  return Object.assign(editor, {
    isShortcode: element => Element$2.isElementType(element, 'shortcode'),
    ...
    hasShortcode: () => {
      const [shortcodeNode] = Editor.nodes(editor, {
        match: node => editor.isShortcode(node)
      });
...
const RichInput = ({
  ...
  const [editor] = React.useState(() => withReact(withHistory(withShortcodes(createEditor()))));
  ...
  const initialValue = React.useMemo(() => [{
    children: toSlateNodeTree(linkedInput.value, validCodes)
  }]);
  const storeValueForSubmit = updatedContent => editor.isContentChanging() && linkedInput.setRangeText(toStorableString(updatedContent), 0, linkedInput.value.length);
  ...
  const classes = ['disabled', 'readOnly'].filter(state => linkedInput[state]).reduce((classnames, modifier) => `${classnames} ${block}--${modifier}`, block);
  return /*#__PURE__*/React.createElement(Slate, {
    editor: editor,
    value: initialValue,
    onChange: storeValueForSubmit
  }, /*#__PURE__*/React.createElement(reactstrap.InputGroup, null, /*#__PURE__*/React.createElement(reactstrap.InputGroupAddon, {
    addonType: "prepend"
  }, /*#__PURE__*/React.createElement(InputMenu, {
    title: "shortcode"
    ...
    renderElement: React.useCallback(Element)
  }), /*#__PURE__*/React.createElement(reactstrap.InputGroupAddon, {
    addonType: "append"
...
var RichInput$1 = (props => /*#__PURE__*/React.createElement(RichInput, props));

var registerComponents = (() => {
  Injector.component.registerMany({
    ShortcodableTextField: RichInput$1
  });
});

/* global window */
var registerReactComponentsWithInjector = (() => window.document.addEventListener('DOMContentLoaded', () => {
  registerComponents();
}));
